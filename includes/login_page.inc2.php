...
<br>
<b class="value"><img src="assets/images/clogo.gif" style="width:200%"></b></div>
...
label{font-size:18px;font-color:#00A4D3}
 	...
 	<div  class="container" id="Statsfrm1"> 
 	<div class="container" style="margin:2px 200px 10px 200px;height:50%;">
 


<BR><BR>  
 <h2><b style="color:#00A4D3"> <img src="images/signin.jpg" width="80px" height="80px"> </b></h2><br>
...
?>
  ...
  <table width="100%">	<tr id="abcd">  
		<td><label>User Name: </label></td>
		<td align="left"><input type="text" name="uid" autofocus style="border:solid 1px #B0B0B0 ;"/></td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>    
...
<tr id="abcd">
<td></td>
 <td><button class="btn btn-large" name="submit" type="submit">Login</button>
				</td><td><a href=# onClick="pop('popDiv')" style="color:orange">Forgot Password</a> 
 </td></tr> </table>
  </form> 
